...
class TrainOptimizerConfig(BaseConfig):
    ...
    auto_kappa_p: False
    compile: False
    riemannion_init_scale: float
    riemannion_sigma_floor: float
    ...
    def default_values():
        ...
        data.append(("riemannion_init_scale", None, float, True))
        data.append(("riemannion_sigma_floor", None, float, True))
