...
class BaseOptimizerParamsWindowView:
    ...
    def build_dynamic_content(self, master, controller, optimizer_ui_state,
        ...
        KEY_DETAIL_MAP = {
            ...
            'riemannion_init_scale': {'title': 'Manifold Init Scale', 'tooltip': 'Initial singular value for zero initialized LoRA pairs.', 'type': 'float'},
            'riemannion_sigma_floor': {'title': 'Sigma Floor', 'tooltip': 'Lower bound on singular values during retraction.', 'type': 'float'},
        }
        # @formatter:on
