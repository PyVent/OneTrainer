...
class StableDiffusionFineTuneModelSaver(
    ...
    def save(
        ...
        embedding_format = ModelFormat.INTERNAL if output_model_format == ModelFormat.INTERNAL else ModelFormat.SAFETENSORS
        embedding_model_saver.save_multiple(model, embedding_format, output_model_destination, dtype)
